...
public class ByPriceController {
    ...
    @Autowired
    private ResponseServiceWithTwoParam responseServiceByPriceAdmin;
    @Autowired
    private ResponseServiceWithThreeParam responseServiceByPriceAndStringAdmin;
    ...
    public ResponseEntity<?> getAllByPrice(@RequestParam(value = "page") Integer page,
        ...
        if (type != null) {
            if (type.equals("asc")) {
                return responseServiceByPriceAdmin.getResponseEntity(
    ...
    public ResponseEntity<?> getAllByPriceAndCarBrand(@RequestParam(value = "page") Integer page,
        ...
        if (type != null) {
            if (type.equals("asc")) {
                return responseServiceByPriceAndStringAdmin.getResponseEntity(
