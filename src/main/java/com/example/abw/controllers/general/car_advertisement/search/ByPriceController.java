...
public class ByPriceController {
    ...
    public ResponseEntity<?> getAllByPrice(PageableParams pageableParams,
        ...
        List<Advertisement> advertisements = carAdvertisementServiceImpl.findAllByPrice(startPrice, endPrice, false, pageableParams);
    ...
    public ResponseEntity<?> getAllByPriceAndCarBrand(PageableParams pageableParams,
        ...
        List<Advertisement> advertisements = carAdvertisementServiceImpl.
