...
@Service
public class CarAdPagBetweenPriceAndCarBrandDateDesc implements
    ...
    @Override
    public List<Ad> getPaginationResult(Long start, Long end, String carBrand, int page, int size) {
        ...
        return new ArrayList<>(carAdPaginationRepository
                .readAllByPriceBetweenAndSoldAndCarBrand_Name(start, end, false, carBrand, sortedByDate));
    }

    @Override
    public List<Ad> getPaginationResultByDefault(Long start, Long end, String carBrand, int page) {
