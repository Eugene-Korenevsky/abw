...
public interface CarAdPagServiceWithOneParam<T> {
    public List<Ad> getPaginationResult(T param, int page, int size, String filter, SortKind sortKind,boolean isAdmin);

    public List<Ad> getPaginationResultByDefault(T param, int page, String filter, SortKind sortKind,boolean isAdmin);
}
